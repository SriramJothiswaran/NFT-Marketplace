...
const NFTCard = ({ nft, onProfilePage }) => {
  ...
  return (
    <Link href={{ pathname: '/nft-details', query: nft }}>
      <div className='flex-1 p-4 m-4 bg-white shadow-md cursor-pointer min-w-215 max-w-max xs:max-w-none sm:w-full sm:min-w-155 minmd:min-w-256 minlg:min-w-327 dark:bg-nft-black-3 rounded-2xl minlg:m-8 sm:m-2'>
